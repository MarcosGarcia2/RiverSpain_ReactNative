...
export default DetallesPez = ({ route }) => {
  const { pez } = route.params;
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Detalles del Pez</Text>
      </View>
      <Animatable.View animation="fadeInUp" duration={800} style={styles.header}>
        <Text style={styles.titulo}>{pez.nombrecomun}</Text>
        <Text style={styles.subtitulo}>{pez.nombrecientifico}</Text>
      </Animatable.View>
      <Animatable.View animation="zoomIn" duration={800} delay={200} style={styles.imageContainer}>
        <Image source={
          imagenError || !pez.urlimagen
      ...
      <Animatable.View animation="fadeInUp" duration={800} delay={400} style={styles.infoContainer}>
        ...
        <Text style={styles.texto}>{pez.origen}</Text>
        <Text style={styles.label}>Taxonomía:</Text>
        <Text style={styles.texto}>{pez.taxonomia}</Text>
        <Text style={styles.label}>Descripción:</Text>
        <Text style={styles.texto}>{pez.descripcion}</Text>
        <Text style={styles.label}>Distribución:</Text>
        <Text style={styles.texto}>{pez.distribucion}</Text>
        <Text style={styles.label}>Biología y Ecología:</Text>
        <Text style={styles.texto}>{pez.biologiaecologia}</Text>
      </Animatable.View>
